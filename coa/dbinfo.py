...
def generic_info(namedb, keys):
    ...
    if namedb == 'spf':
        ...
        'total_boosters':['total_boosters:FILLIT'],
        'total_people_vaccinated':['original name : people vaccinated'],
        'total_people_fully_vaccinated':['original name : people_fully_vaccinated'],
