...
def generic_info(namedb, keys):
    ...
    if namedb == 'spf':
        ...
        ['tot_dc:FILLIT',url1],
        'cur_hosp':
        ['cur_hosp:FILLIT',url1],
        'tot_rad':
        ['tot_rad:FILLIT',url1],
        'cur_rea':
        ['cur_rea:FILLIT',url1],
        'cur_idx_tx_incid':
        ['cur_idx_tx_incid:FILLIT',url2],
        'cur_idx_R':
        ['cur_idx_R:FILLIT',url4],
        'cur_idx_taux_occupation_sae':
        ['cur_idx_taux_occupation_sae:FILLIT',url4],
        'cur_idx_tx_pos':
        ['cur_idx_tx_pos:FILLIT',url4],
        'tot_vacc':
        ['tot_vacc: (nom initial n_cum_dose1)',url5],
        'tot_vacc2':
        ['tot_vacc2: (nom initial n_cum_dose2)',url5],
        'tot_incid_hosp':
        ['tot_incid_hosp: Nombre total de personnes hospitalisées',url2],
        'tot_incid_rea':
        ['tot_incid_rea: Nombre total d\'admissions en réanimation',url2],
        'tot_incid_rad':
        ['tot_incid_rad: Nombre total de  retours à domicile',url2],
        'tot_incid_dc':
        ['tot_incid_dc: Nombre total de personnes  décédées',url2],
        'tot_P':
        ['tot_P: Nombre total de tests positifs',url3],
        'tot_T':
        ['tot_T: Nombre total de tests réalisés',url3],
        'cur_idx_Prc_tests_PCR_TA_crible' :
        ['Prc_tests_PCR_TA_crible: % de tests PCR criblés parmi les PCR positives.',url6],
        'cur_idx_Prc_susp_501Y_V1' :
        ['Prc_susp_501Y_V1: % de tests avec suspicion de variant 20I/501Y.V1 (UK).\n Royaume-Uni (UK): code Nexstrain= 20I/501Y.V1.',url6],
        'cur_idx_Prc_susp_501Y_V2_3' :
        ['Prc_susp_501Y_V2_3: % de tests avec suspicion de variant 20H/501Y.V2 (ZA) ou 20J/501Y.V3 (BR).Afrique du Sud (ZA) : code Nexstrain= 20H/501Y.V2. Brésil (BR) : code Nexstrain= 20J/501Y.V3',url6],
        'cur_idx_Prc_susp_IND' :
        ['Prc_susp_IND: % de tests avec une détection de variant mais non identifiable',url6],
        'cur_idx_Prc_susp_ABS' :
        ['Prc_susp_ABS: % de tests avec une absence de détection de variant',url6]
        }
        mydico = spfdic
