      ...
      if namedb in _db_list_dict.keys():
          ...
          if namedb == 'owid':
            ...
            if not exists_from_url(url):
              url='https://zenodo.org/records/10082220/files/owid_owid-covid-data.csv'
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082026/files/dgs_data_concelhos_new.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082058/files/dpc_covid19-ita-regioni.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082082/files/europa_jrc-covid-19-all-days-by-regions.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator={url:','}
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082068/files/escovid19data_covid19-provincias-spain_consolidated.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082142/files/govcy.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
            ...
            jhu_zenodo = {
                'tot_deaths':['deaths','https://zenodo.org/records/10082179/files/jhu_time_series_covid19_deaths_global.csv'],\
                'tot_confirmed':['confirmed','https://zenodo.org/records/10082179/files/jhu_time_series_covid19_confirmed_global.csv'],\
                'tot_recovered':['recovered','https://zenodo.org/records/10082179/files/jhu_time_series_covid19_recovered_global.csv']\
            }
            ...
            jpn_zenodo = {
             'tot_deaths':['deaths_cumulative_daily','https://zenodo.org/records/10082188/files/jpnmhlw_deaths_cumulative_daily.csv'],\
             'cur_cases':['newly_confirmed_cases_daily','https://zenodo.org/records/10082188/files/jpnmhlw_newly_confirmed_cases_daily.csv'],\
             'cur_cases_per_100_thousand':['newly_confirmed_cases_per_100_thousand_population_daily','https://zenodo.org/records/10082188/files/jpnmhlw_newly_confirmed_cases_per_100_thousand_population_daily.csv'],\
             'tot_cases':['confirmed_cases_cumulative_daily','https://zenodo.org/records/10082188/files/jpnmhlw_confirmed_cases_cumulative_daily.csv'],\
             'cur_severe_cases':['severe_cases_daily','https://zenodo.org/records/10082188/files/jpnmhlw_severe_cases_daily.csv'],\
             'cur_deaths':['number_of_deaths_daily','https://zenodo.org/records/10082188/files/jpnmhlw_number_of_deaths_daily.csv'] ,\
            }
            ...
            if not exists_from_url(url0):
                url0='https://zenodo.org/records/10082204/files/moh_cases_state.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url0)
            url1='https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/hospital.csv'
            if not exists_from_url(url1):
                url1='hosp_covid','https://zenodo.org/records/10082204/files/moh_hospital.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url1)
            url2='https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/icu.csv'
            if not exists_from_url(url2):
                url2='https://zenodo.org/records/10082204/files/moh_icu.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url2)
            url3='https://raw.githubusercontent.com/CITF-Malaysia/citf-public/main/vaccination/vax_state.csv'
            if not exists_from_url(url3):
                url3='https://zenodo.org/records/10082204/files/moh_vax_state.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url3)
            url4='https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/deaths_state.csv'
            if not exists_from_url(url4):
                url4='https://zenodo.org/records/10082204/files/moh_deaths_state.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url4)
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10083685/files/mpoxgh_owid-monkeypox-data.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
            ...
            phe_zenodo = {
                'tot_deaths':['cumDeaths28DaysByDeathDate','https://zenodo.org/records/10222748/files/phe_cumDeaths28DaysByDeathDate.csv'],\
                'tot_cases':['cumCasesBySpecimenDate','https://zenodo.org/records/10222748/files/phe_cumCasesBySpecimenDate.csv'],
                'tot_tests':['cumLFDTestsBySpecimenDate','https://zenodo.org/records/10222748/files/phe_cumLFDTestsBySpecimenDate.csv'],
                'tot_vacc1':['cumPeopleVaccinatedFirstDoseByVaccinationDate','https://zenodo.org/records/10222748/files/phe_cumPeopleVaccinatedFirstDoseByVaccinationDate.csv'],
                'tot_vacc2':['cumPeopleVaccinatedSecondDoseByVaccinationDate','https://zenodo.org/records/10222748/files/phe_cumPeopleVaccinatedSecondDoseByVaccinationDate.csv']
            }
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10082320/files/rki_deaths-rki-by-ags.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            ...
            #if not exists_from_url(url):
            #    url='https://zenodo.org/records/10083588/files/spf_table-indicateurs-open-data-dep-2023-06-30-17h59.csv'
            #    print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
            ...
            if not exists_from_url(url):
                url='https://zenodo.org/records/10083608/files/sciensano_COVID19BE_HOSP.csv'
                print('Original file unavailable, swtching to Zenodo backup ', url)
            self.separator = {url:','}
